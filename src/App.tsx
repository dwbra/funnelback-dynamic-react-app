...
function App({ fbConfig, templates, selectors }: any) {
  ...
  return (
    <>
      {selectors.search?.parentNode ? <Search /> : null}
      {selectors.totalResults?.parentNode ? <TotalResults /> : null}
      {selectors.facets?.parentNode ? <Facets /> : null}
      {selectors.results?.parentNode ? <Results /> : null}
      {selectors.pagination?.parentNode ? <Pagination /> : null}
      {selectors.sort?.parentNode ? <Sort /> : null}
    </>
  );
}
